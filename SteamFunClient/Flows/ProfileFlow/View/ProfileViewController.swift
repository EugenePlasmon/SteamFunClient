...
final class ProfileViewController: UIViewController {
    ...
    private let navbarConfig = ExpandableNavbarViewController.Config(backgroundBlurColor: .zeratul,
    ...
    private func addNavbar(viewModel: ProfileViewModel) {
        ...
        navbar.scrollView >>- { navbar.scrollViewDidScroll($0, updateScrollViewOffsetIfNeeded: true) }
    }
